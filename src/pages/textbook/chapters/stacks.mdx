  ...
  return (
    <>
      ...
      <p>
        ...
        principle. The last item added to the stack is the first item to be
        removed. Think of it like a stack of plates - you always remove the top
        plate first.
      </p>
      <p>
        In programming, stacks are commonly used for keeping track of function
        calls, undo/redo functionality, and in algorithms such as depth-first
        search.
      </p>
