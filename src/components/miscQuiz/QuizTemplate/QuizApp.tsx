...
import { fetchTrivia, Difficulty, QuestionState } from '../QuizAPI';
import QuestionCard from './QuizCards';
import { GlobalStyle, Wrapper } from './QuizStyle';
import {Modal, ModalProps} from 'rsuite'

//interface QuizProps extends ModalProps {
  //  onStartQuiz: (event: React.MouseEvent) => void;
  //}
